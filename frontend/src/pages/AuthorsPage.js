...
a.country.toLowerCase().includes(searchTerm.toLowerCase()))
 ...
 setForm({ firstName: author.firstName, lastName: author.lastName, country:
author.country });
...
className="btn-delete">🗑</button>
 ...
 onChange={handleChange}
 />
 <button type="submit" className="btn-save">{editingId ? 'Enregistrer' :
'Ajouter'}</button>
 {editingId && <button type="button" onClick={() => { setForm({ firstName: '',
lastName: '', country: '' }); setEditingId(null); }} className="btncancel">Annuler</button>}
 </form>
 </div>
 );
};
